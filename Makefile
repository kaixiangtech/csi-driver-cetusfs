...
install:
	...
	install -m 644 deploy/kubernetes/rbac/csi-cetusfs-attacher-rbac.yaml ${DESTDIR}/usr/share/doc/cetusfsplugin/kubernetes/rbac/csi-cetusfs-attacher-rbac.yaml
	install -m 644 deploy/kubernetes/rbac/csi-cetusfs-provisioner-rbac.yaml ${DESTDIR}/usr/share/doc/cetusfsplugin/kubernetes/rbac/csi-cetusfs-provisioner-rbac.yaml
	install -m 644 deploy/kubernetes/rbac/csi-cetusfs-resizer-rbac.yaml ${DESTDIR}/usr/share/doc/cetusfsplugin/kubernetes/rbac/csi-cetusfs-resizer-rbac.yaml
