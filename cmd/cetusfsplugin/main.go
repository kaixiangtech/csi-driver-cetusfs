...
import (
    ...
    "192.168.108.165/kubernetes-csi/csi-driver-cetusfs/pkg/cetusfs"
)

func init() {
    flag.Set("logtostderr", "false")
    flag.Set("log_dir", "/var/log/cetusfsplugin")
}

var (
    endpoint          = flag.String("endpoint", "unix://tmp/csi.sock", "CSI endpoint")
    driverName        = flag.String("drivername", "cetusfs.csi.k8s.io", "name of the driver")
...
func handle() {
    driver, err := cetusfs.NewCetusFSDriver(*driverName, *nodeID, *endpoint, *ephemeral, *maxVolumesPerNode, version)
    if err != nil {
