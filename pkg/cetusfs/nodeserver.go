...
const TopologyKeyNode = "topology.cetusfs.csi/node"
...
func (ns *nodeServer) NodePublishVolume(ctx context.Context, req *csi.NodePublishVolumeRequest) (*csi.NodePublishVolumeResponse, error) {
    ...
    if ephemeralVolume {
        ...
        vol, err := createCetusfsVolume(req.GetVolumeId(), volName, maxStorageCapacity, mountAccess, ephemeralVolume)
...
func (ns *nodeServer) NodeUnpublishVolume(ctx context.Context, req *csi.NodeUnpublishVolumeRequest) (*csi.NodeUnpublishVolumeResponse, error) {
    ...
    glog.V(4).Infof("cetusfs: volume %s has been unpublished.", targetPath)

    if vol.Ephemeral {
        glog.V(4).Infof("deleting volume %s", volumeID)
        if err := deleteCetusfsVolume(volumeID); err != nil && !os.IsNotExist(err) {
...
func (ns *nodeServer) NodeExpandVolume(ctx context.Context, req *csi.NodeExpandVolumeRequest) (*csi.NodeExpandVolumeResponse, error) {
    ...
    if vol.VolSize < capacity {
        ...
        if err := updateCetusfsVolume(volID, vol); err != nil {
